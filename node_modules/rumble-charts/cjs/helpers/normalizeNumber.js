...
function normalizeNumber(number, absolute) {
    ...
    if (number > 0 && number <= 1) {
        if (number > 0 && !showedDeprecationWarning) {
            ...
            console.warn("DEPRECATION WARNING. Please write \"".concat(Math.round(number * 100), "%\" instead of ").concat(number, ". In the future versions of 'rumble-charts', the latter notation will be removed."));
        }
