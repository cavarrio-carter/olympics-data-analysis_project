...
function Chart(allProps) {
    ...
    if (!isNumber.isNumber(_layerWidth)) {
        throw "Props \"width\" (as number), \"layerWidth\" or \"viewBox\" expected for <Chart> component. ".concat(JSON.stringify(_layerWidth), " received instead.");
    }
    if (!isNumber.isNumber(_layerHeight)) {
        throw "Props \"height\" (as number), \"layerHeight\" or \"viewBox\" expected for <Chart> component. ".concat(JSON.stringify(_layerHeight), " received instead.");
    }
