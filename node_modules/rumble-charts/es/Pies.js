...
function Pies(props) {
    ...
    return React.createElement("g", { className: className, style: style, transform: "translate(".concat((coords.x + outerRadius), " ").concat((coords.y + outerRadius), ")"), opacity: opacity }, (_a = props.series) === null || _a === void 0 ? void 0 : _a.map(function (series, index) {
        var _a;
