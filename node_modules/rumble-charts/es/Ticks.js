...
function renderLabel(_a) {
    ...
    if (isString(label) || isNumber(label)) {
        return React.createElement("text", __assign({ style: labelStyle, className: className && ("".concat(className, "-label ").concat(className, "-label-").concat(index)) }, labelAttributes), value(props.labelFormat, label + '') || label);
    }
    else {
        return label;
    }
...
function renderLine(_a) {
    ...
    return React.createElement("path", __assign({ style: lineStyle, className: className && ("".concat(className, "-line ").concat(className, "-line-").concat(index)), d: d }, lineAttributes));
}
